...
class GameView implements \model\StickGameObserver {
	...
	*/
	public function playerSelectSticks() {
		return isset($_GET[self::$draw]); //Använder sig av $_GET, vilket den inte får.
	}
	...
	* @return string
	*/
	public function checkGetDraw()
	{
		return $_GET[self::$draw];		
	}
	
	/** 
	* @return String HTML
	*/
	public function getUnauthorizedMsg()
	{
		return "<h1>Unauthorized input</h1>";
	}
	...
	public function setMsg($value)
	{
		switch ($value) {
			case 1:
				$message = "<p>AIPlayer - \"Grr...\" </p>";
				
				echo $message;
				break;
			case 2:
				$message = "<p>AIPlayer - \"Got you, you have already lost!!!\"</p>  ";
